...
const ResumeBuilderPage: React.FC<ResumeBuilderPageProps> = ({ onStart, onBack }) => {
  return (
    <>
      <Helmet>
        <title>Free Resume Builder | AI Resume Builder & Free Resume Download</title>
        <meta
          name="description"
          content="Build a professional, ATS-friendly resume for free using our AI Resume Builder. Download your resume instantly in PDF format."
        />
        <link
          rel="canonical"
          href="https://buildresumenow.in/resume-builder"
        />
        <meta
          property="og:url"
          content="https://buildresumenow.in/resume-builder"
        />
