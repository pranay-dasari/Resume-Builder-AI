...
export const ProfessionalTemplate: React.FC<CoverLetterTemplateProps> = ({ data, customization, template }) => {
...
export const ProfessionalThumbnail: React.FC<{ template: CoverLetterTemplate }> = ({ template }) => {
