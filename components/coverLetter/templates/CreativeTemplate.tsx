...
export const CreativeTemplate: React.FC<CoverLetterTemplateProps> = ({ data, customization, template }) => {
...
export const CreativeThumbnail: React.FC<{ template: CoverLetterTemplate }> = ({ template }) => {
        ...
        <div className={baseStyles}>
            <div className="p-2 w-full flex">
                <div className="w-2/3 flex flex-col">
                    <div
                        className="h-3 w-3/4 rounded-sm mb-1"
