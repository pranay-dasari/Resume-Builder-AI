...
export const ExecutiveTemplate: React.FC<CoverLetterTemplateProps> = ({ data, customization, template }) => {
...
export const ExecutiveThumbnail: React.FC<{ template: CoverLetterTemplate }> = ({ template }) => {
        ...
        <div className={baseStyles}>
            <div className="p-2 w-full flex flex-col items-center">
                <div className="text-center mb-2 w-full">
                    <div
                        className="h-3 w-1/2 rounded-sm mx-auto mb-1"
